...
#------------------------------------------------------------
formula <- bf(rt | dec(sayhi) ~ 1 + intensity + (1 + intensity | s | ID),
              bs ~ 1 + (1 | s | ID),
              ndt ~ 1 + (1 | s | ID),
              bias ~ 1 + (1 | s | ID))
...
saveRDS(final_ddm_fit_6, file = "models/fit_6b_ddm_final.rds")
saveRDS(pred_final_ddm_6, file = "models/pred_6b_ddm_final.rds")
